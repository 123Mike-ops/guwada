			...
			<div class="row">
				<div class="col-lg-12" style="padding-top: 100px;">
					<div class="heading-title text-center">
						<h2>Reservation</h2>
						<p>Confirm Booking in {{$restname}} </p>
					</div>
				</div>
			</div>
			@if($check=="[]")
		<div class="col-lg-3 col-md-6">
			<h3>Subscribe Us </h3><label>be Our Customer to get more benefit</label>
			<div class="subscribe_form">
				<form class="subscribe_form">
					{{-- <input name="EMAIL" id="subs-email" class="form_input" placeholder="Email Address..." type="email"> --}}
				<a href="{{route('Add.Customer',['restId'=>$restId,'userId'=>Auth::user()->id])}}" type="submit" class="submit">SUBSCRIBE</a>
		...
		@endif 
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					...
					<form action="{{route('book.post',['foodId'=>$foodId,'restId'=>$restId,'typeId'=>$typeId,'userId'=>$userId])}}"  method="POST">
							@csrf
						<div class="row">
								<div class="col-md-6">
									<h3>Book a table</h3>
									<div class="col-md-12">
										<div class="form-group">
											<input id="input_date" name="bookDate" class="datepicker picker__input form-control" name="date" type="text" value="" equired data-error="Please enter Date">
